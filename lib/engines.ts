...
export const defaultVoyage = { fixtureId: 'VQ-2026-001', isDraft: false, origin: 'Muara Berau, Indonesia', destination: 'Paradip Port, India', commodity: 'Thermal Coal', cargoQuantity: 80000, deliveryDate: '12–15 October 2026', vesselPreference: 'Auto Select' as VesselType, selectedVessel: 'Panamax' as VesselType, contractDuration: 'Short-Term', charterPreference: 'Flexible', marketPreference: 'Flexible', marketCondition: 'Stable' as MarketCondition, portCongestion: 'Low' as Congestion, vesselAvailability: 72, forecastRange: '30D' as ForecastRange, laycanWindow: '12–15 Oct 2026', laycanStart: '2026-10-12', laycanEnd: '2026-10-15' }
